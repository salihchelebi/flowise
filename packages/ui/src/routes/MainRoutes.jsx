...
const SectoralAgents = Loadable(lazy(() => import('@/views/sectoral-agents')))
const SectoralSeoEngineer = Loadable(lazy(() => import('@/views/sectoral-agents/SeoEngineer')))
...
const MainRoutes = {
    ...
    children: [
        ...
        {
            path: '/sectoral-agents/seo-engineer',
            element: (
